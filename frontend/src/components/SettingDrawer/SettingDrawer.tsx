...
import { useUrlSearchParams } from 'utils/use-params';
...
const Body = function ({ children, hashId, prefixCls, title }: BodyProps) {
  return (
...
// type TmpKeysType = keyof Partial<ProSettings>;
// const getDifferentSetting = (state: Partial<ProSettings>): Record<string, any> => {
//   const stateObj: Partial<ProSettings> = {};
//   Object.keys(state).forEach((key) => {
//     if (state[key as TmpKeysType] !== defaultSettings[key as TmpKeysType] && key !== 'collapse') {
//       // @ts-ignore
//       stateObj[key as TmpKeysType] = state[key as TmpKeysType];
//     } else {
//       stateObj[key as TmpKeysType] = undefined;
//     }
//     // @ts-ignore
//     if (key.includes('Render')) stateObj[key as TmpKeysType] = state[key as TmpKeysType] === false ? false : undefined;
//   });
//   stateObj.menu = undefined;
//   return stateObj;
// };
